...
import kotlinx.android.synthetic.main.forecast_recyclerview_item.view.*
...
class ForecastAdapter(
    ...
    private var list: ArrayList<com.example.kotlinforecast.data.model.forecastWeather.List> = ArrayList()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ForecastViewHolder {
        val layoutInflater = LayoutInflater.from(parent.context)
        val contactRow = layoutInflater.inflate(R.layout.forecast_recyclerview_item, parent, false)
        return ForecastViewHolder(contactRow)
    }
    ...
    fun updateForecast(forecastList: ArrayList<com.example.kotlinforecast.data.model.forecastWeather.List> ) {
        this.list = forecastList
        notifyDataSetChanged()
    }

    override fun onBindViewHolder(holder: ForecastViewHolder, position: Int) {
        val time = holder.view.time_text_view_item_forecast
        val tempMax = holder.view.temp_max_text_view_item_forecast
        val tempMin = holder.view.temp_min_text_view_item_forecast
        val icon = holder.view.icon_image_view_item_forecast
